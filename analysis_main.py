...
for dict_dataset in tqdm(list_dataset_dicts[:1]):
    ...
    for idx, row_data in tqdm(list(df_data.iterrows())[:]): # 23:24 iterate through sets
        pass
        # if row_data.name != "04_19_2019_idx_101":
            # continue
        ...
        #     continue
        analysis_type = 'cell_without_toxo'
        ...
        if analysis_type == 'cell_without_toxo':
            ...
            mask_cell=mask_whole_cell_no_toxo
        ...
        df_props.to_csv(path_output_features / f"{idx}_{analysis_type}.csv")  
...
#%% CREATE ONE CSV 
    ...
    # path_output_proprs_type = path_output_props / analysis_type    
        list_path_features_csv = list(path_output_features.glob(f"*{analysis_type}.csv"))
    ...
    df_all_props.to_csv(path_feature_summaries / f"{d}_all_props_cells_{analysis_type}.csv")
